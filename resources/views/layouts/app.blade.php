...
<body class="h-screen bg-gray-100 text-gray-800 flex flex-col">
        ...
        <div class="flex justify-between items-center">
            ...
            <form method="POST" action="{{ route('logout') }}">
                ...
                <button type="submit"
                    ...
                    <!-- Ikon Keluar untuk mobile -->
                    <span class="md:hidden">
                        <i class="fa-solid fa-arrow-right-from-bracket"></i>
                    </span>
                    <!-- Teks Keluar untuk desktop -->
    ...
    @endphp
        ...
        {{-- Main Content --}}
        <main class="flex-1 p-8 bg-cover bg-center bg-white overflow-y-auto" style="background-image: url('images/line.png')">
            @yield('content')
        </main>
    </div>
</body>
