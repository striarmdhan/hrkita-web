...
<body class="min-h-screen text-gray-800 flex bg-white flex-col">
    ...
    <nav class="flex items-center justify-between bg-white px-6 md:px-16 py-4 shadow-lg">
        ...
        <a href="#" class="border border-[#0C519D] text-[#0C519D] rounded-md px-4 py-2 text-sm font-medium hover:bg-[#0C519D] hover:text-white transition">
            Sign In
        </a>
    </nav>
    ...
    <section class="flex flex-col md:flex-row items-center justify-between px-6 md:px-16 py-6 bg-white">
        ...
        <div class="w-full md:w-1/3 mb-10 md:mb-0">
            ...
            <a href="#" class="mt-6 inline-block border border-[#0C519D] text-[#0C519D] rounded-md px-6 py-2 text-sm font-bold hover:bg-[#0C519D] hover:text-white transition">
                Sign In
            </a>
        </div>
    ...
    <!-- FITUR UNGGULAN -->
    <section class="bg-[#E6F0FF] py-20 px-6 md:px-16">
        ...
        <div class="grid grid-cols-1 md:grid-cols-2 gap-6 max-w-3xl mx-auto">
            <div class="bg-white p-6 rounded-xl shadow text-start">
                <div class="flex text-center items-center justify-center bg-[#E6F0FF] p-2 w-16 h-16 rounded-md mb-4">
                    <i class="fas fa-id-badge text-3xl text-[#0C519D]"></i>
                </div>
            ...
            <div class="bg-white p-6 rounded-xl shadow text-start">
                <div class="flex text-center items-center justify-center bg-[#E6F0FF] p-2 w-16 h-16 rounded-md mb-4">
                    <i class="fas fa-calendar-check text-3xl text-[#0C519D]"></i>
                </div>
            ...
            <div class="bg-white p-6 rounded-xl shadow text-start">
                <div class="flex text-center items-center justify-center bg-[#E6F0FF] p-2 w-16 h-16 rounded-md mb-4">
                    <i class="fas fa-plane-departure text-3xl text-[#0C519D]"></i>
                </div>
            ...
            <div class="bg-white p-6 rounded-xl shadow text-start">
                <div class="flex text-center items-center justify-center bg-[#E6F0FF] p-2 w-16 h-16 rounded-md mb-4">
                    <i class="fas fa-building text-3xl text-[#0C519D]"></i>
                </div>
